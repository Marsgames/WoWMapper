...
capitalCity.Orgrimmar["Name"] = "Orgrimmar"
capitalCity.Orgrimmar["Affiliation"] = "Horde"
capitalCity.Orgrimmar["Location"] = "Kalimdor"
capitalCity.Orgrimmar["Races"] = {"Orcs", "Trolls ?", "Gobelins ?", "Morts vivants ?"}
capitalCity.Orgrimmar["Ruler"] = "Sylvanas"
capitalCity.Orgrimmar["Description"] = "Orgrimmar est la capitale de la Horde. Située au nord de la région de Durotar, en Kalimdor. On trouve de nombreux services et quêtes dans cette ville, ainsi que des Hôtel des ventes, une banque, des marchands d'animaux de compagnie, et des Maîtres pour tous les Métiers et toutes les Classes. En tant que capitale des Orcs, Orgrimmar est le lieu de résidence de Varok Saurcroc et abrite de nombreux quartiers où demeurent toutes les populations de la Horde."

capitalCity.Stormwind = {}
capitalCity.Stormwind["Name"] = "Hurlevent"
capitalCity.Stormwind["Affiliation"] = "Alliance"
